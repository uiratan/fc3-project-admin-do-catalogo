...
public class GenreJpaEntity {
    ...
    public static GenreJpaEntity from(final String anId, final String aName, final boolean isActive) {
        return new GenreJpaEntity(anId, aName, isActive, Instant.now(), Instant.now(), null);
    }
