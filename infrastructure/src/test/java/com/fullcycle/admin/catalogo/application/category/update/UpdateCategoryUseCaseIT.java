...
public class UpdateCategoryUseCaseIT {
    ...
    public void givenAValidCommand_whenCallsUpdateCategory_shouldReturnCategoryId() {
        ...
        Assertions.assertEquals(getTruncatededTo(aCategory.getCreatedAt()), getTruncatededTo(actualCategory.getCreatedAt()));
    ...
    public void givenAValidCommand_whenGatewayThrowsRandomException_shouldReturnAException() {
        ...
        Assertions.assertEquals(getTruncatededTo(aCategory.getCreatedAt()), getTruncatededTo(actualCategory.getCreatedAt()));
        Assertions.assertEquals(getTruncatededTo(aCategory.getUpdatedAt()), getTruncatededTo(actualCategory.getUpdatedAt()));
    ...
    private Instant getTruncatededTo(Instant createdAt) {
